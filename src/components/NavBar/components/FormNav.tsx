...
const FormNav = ({ handleSubmit, search, setSearch }: Props) => {
  return (
    <form
      className=" flex px-2 w-full md:w-60 lg:w-80 flex-row rounded-sm md:rounded-full border-2 hover:border hover:border-anime-blue border-anime-dark-200 bg-anime-dark-200 justify-around transition duration-500 ease-out"
